...
for layer in range(depth):
    ...
    filename='measureevo/results_date=2021-08-16-15-25-35_trial=0_ResNet18CIFAR_CIFAR10_SGDweight_decay=0.0_momentum=0.0_StepLRstep_size=25.0_gamma=0.5_LR=0.03_measure=ER_zeta=1.0.pickle'
